...
//            case .uofm:
//                if let UofMViewController = self.storyboard?.instantiateViewController(withIdentifier: "UofMViewController") as? UofMViewController {
//                    UofMViewController.blePeripheral = blePeripheral
//                    show(UofMViewController, sender: self)
//                }
